...
export function ManagedHosts(){
 ...
 const [name,setName]=useState(''),[connection,setConnection]=useState({host:'',port:22,username:'root',password:'',privateKey:'',passphrase:'',fingerprint:'',releaseTag:'v0.1.4'});
 ...
 return <section className="managed-hosts">
  ...
  <p className="hint">{t("当前预览支持 Ubuntu、Debian、Fedora 的 x86_64 主机和 systemd。主机需要能连接 SSH，并能向外访问 HTTPS。")}</p>
