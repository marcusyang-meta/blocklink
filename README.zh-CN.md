...
Windows 版本已在本地测试。Linux x64、Apple Silicon 与 Intel Mac 均已通过原生构建和后台启动测试，提供预览下载。Mac/Linux 的游戏窗口、声音、输入和光影仍待实机验收。请以各 Release 的实际附件与说明为准，详见 [平台说明](PLATFORMS.zh-CN.md)。
...
[更新记录](CHANGELOG.zh-CN.md) · [整合包](MODPACKS.zh-CN.md) · [世界与服务器](WORLDS.zh-CN.md) · [联机](NETWORK.zh-CN.md) · [部署大厅](lobby/README.md) · [多语言](desktop/I18N.md) · [验收状态](VALIDATION.zh-CN.md)

欢迎在 [Issues](https://github.com/marcusyang-meta/blocklink/issues) 提交问题和想法，开发贡献见 [CONTRIBUTING.md](CONTRIBUTING.zh-CN.md)。请不要在公开反馈中附带令牌或私人邀请。
